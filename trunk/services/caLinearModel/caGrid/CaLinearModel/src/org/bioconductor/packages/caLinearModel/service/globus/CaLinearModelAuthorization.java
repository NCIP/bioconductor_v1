 ...
 * 
 */
public class CaLinearModelAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caLinearModel.packages.bioconductor.org/CaLinearModel";
	
	
	public CaLinearModelAuthorization() {
	}
	...
	public static void authorizeFit() throws RemoteException {
		
		
	}
					
	public static void authorizeTwoChannelFit() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("fit")){
			try{
				authorizeFit();
				return true;
			} catch (Exception e){
