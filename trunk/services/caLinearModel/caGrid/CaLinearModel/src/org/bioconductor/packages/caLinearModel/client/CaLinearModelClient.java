...
/*			  
			  ...
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing PairedTTest");
			  System.out.println("***********************************");
			  // PairedTTest:
			  ...
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing OneFactorANOVA");
			  System.out.println("***********************************");
			  // OneFactorANOVA
			  ...
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing TwoFactorANOVA");
			  System.out.println("***********************************");
			  // TwoFactorANOVA	  
...
//						  expressionDataTwo.getExpressionDataCollection());
			  TwoChannelExpressionDataCollection twoChannelExpressionDataCollection = new TwoChannelExpressionDataCollection();
			  twoChannelExpressionDataCollection.setGreenExpressionDataCollection(expressionDataTwo.getExpressionDataCollection());
			  twoChannelExpressionDataCollection.setRedExpressionDataCollection(expressionDataOne.getExpressionDataCollection());
			  twoChannelExpressionDataCollection.setReporterNames(expressionDataOne.getReporterNames());
			  
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing DyeSwapTTest");
			  System.out.println("***********************************");
			  
			  DyeSwapTTest dstt = new DyeSwapTTest();
			  dstt.setNumberOfTopReporters(expressionDataOne.getExpressionDataCollection(0).getReporterValues().getValues().length);
			  dstt.setReferenceLevel(new FactorValue(null, null, "Low"));
//			  dstt.setReferenceChannelIdentifier("Cy5");
...
//						  else if (i >= 4 & i < 6) dsttAnno[sample].setFactorLevel(new FactorValue(null, null, "Low"));
					  ...
					  dsttAnno[sample].setSampleName("CMHI." + (i+1));
				  }
			  }
			  dstt.setDyeSwapTTestAnnotation(dsttAnno);
			  
			  TopTableCollection dSwapTTestTopTableColl = client.twoChannelFit(twoChannelExpressionDataCollection, dstt);
			  client.displayTopTableCollection(dSwapTTestTopTableColl);
/*			  
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing CommonReferenceANOVA");
			  System.out.println("***********************************");
			  ...
			  comRefANOVATest.setReferenceChannelIdentifier("Cy5");
			  ...
			  TopTableCollection twoFactorANOVATopTableColl = client.twoChannelFit(twoChannelExpressionDataCollection, comRefANOVATest);
			  client.displayTopTableCollection(twoFactorANOVATopTableColl);
*/			  
			  
			  System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing with SingleChannelExpressionDataCollection large files");
			  System.out.println("***********************************");
			  
			  // use CaLinearModelHelper to deserialize serialized-data file to SingleChannelExpressionDataCollection
			  String filePath = "/home/mtra2/R_packages/caLinearModel/test/src/org/bioconductor/rserviceJms/worker/Data/OneChannelTest.oneChannelExpressionData.rda_java.Data";
              org.bioconductor.cagrid.data.SingleChannelExpressionDataCollection largeSingleCED = CaLinearModelHelper.deserializeToSingleChannelExpDataCollection(filePath);

              System.out.println("Done with deserializing OneChannelExpressionData");
              
              // do the same for serialized-data file of SampleAnnotationCollection:
              filePath = "/home/mtra2/R_packages/caLinearModel/test/src/org/bioconductor/rserviceJms/worker/Data/OneChannelTest.sampleAnnotationCollection.rda_java.Data";
              // here, deserialize it to TTest
              ...
              // Now, create a session and use HelperService to move large object:
              org.bioconductor.cagrid.statefulservices.SessionIdentifier session = client.createCaLinearModelSession();
              ...
              helperService.uploadDataObject(session, largeSingleCED);
              client.invokeFit(session, tTest);
              TopTableCollection ttColl; 
              ttColl = (TopTableCollection)helperService.getResultObject(session);
              client.displayTopTableCollection(ttColl);
			  
              System.out.println("\n\n");
			  System.out.println("***********************************");
			  System.out.println("Testing with TwoChannelExpressionDataCollection large files");
			  System.out.println("***********************************");
			  filePath = "/home/mtra2/R_packages/caLinearModel/test/src/org/bioconductor/rserviceJms/worker/Data/TwoChannelTest.twoChannelExpressionData.rda_java.Data";
			  org.bioconductor.cagrid.data.TwoChannelExpressionDataCollection largeTwoCED = CaLinearModelHelper.deserializeToTwoChannelExpDataCollection(filePath);
			  System.out.println("Done with deserializing TwoChannelExpressionData");
			  
			  filePath = "/home/mtra2/R_packages/caLinearModel/test/src/org/bioconductor/rserviceJms/worker/Data/TwoChannelTest.sampleAnnotationCollection.rda_java.Data";
			  // here, deserialize it to CommonReferenceANOVA:
			  org.bioconductor.cagrid.calinearmodel.CommonReferenceANOVA commonRefANOVA = CaLinearModelHelper.deserializeToCommonReferenceANOVA(filePath);
			  // since the serialized data doesn't contain this:
			  commonRefANOVA.setNumberOfTopReporters(10);
			  commonRefANOVA.setReferenceLevel(new FactorValue(null, null, "ref"));			  
			  // use HelperService:
			  helperService.uploadDataObject(session, largeTwoCED);
			  client.invokeTwoChannelFit(session, commonRefANOVA);
			  ttColl = (TopTableCollection)helperService.getResultObject(session);
              client.displayTopTableCollection(ttColl);
...
//                            System.out.println("This is ratio: " + ratio);
  ...
  public java.lang.String getRpackageSessionInfo() throws RemoteException {
    ...
    org.bioconductor.packages.caLinearModel.stubs.GetRpackageSessionInfoRequest params = new org.bioconductor.packages.caLinearModel.stubs.GetRpackageSessionInfoRequest();
    org.bioconductor.packages.caLinearModel.stubs.GetRpackageSessionInfoResponse boxedResult = portType.getRpackageSessionInfo(params);
  ...
  public org.bioconductor.cagrid.statefulservices.SessionIdentifier createCaLinearModelSession() throws RemoteException {
    synchronized(portTypeMutex){
      configureStubSecurity((Stub)portType,"createCaLinearModelSession");
    org.bioconductor.packages.caLinearModel.stubs.CreateCaLinearModelSessionRequest params = new org.bioconductor.packages.caLinearModel.stubs.CreateCaLinearModelSessionRequest();
    org.bioconductor.packages.caLinearModel.stubs.CreateCaLinearModelSessionResponse boxedResult = portType.createCaLinearModelSession(params);
  ...
  public void invokeFit(org.bioconductor.cagrid.statefulservices.SessionIdentifier sessionIdentifier,org.bioconductor.cagrid.calinearmodel.OneChannelModel oneChannelModel) throws RemoteException {
    synchronized(portTypeMutex){
      configureStubSecurity((Stub)portType,"invokeFit");
    org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequest params = new org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequest();
    org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequestSessionIdentifier sessionIdentifierContainer = new org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequestSessionIdentifier();
    sessionIdentifierContainer.setSessionIdentifier(sessionIdentifier);
    params.setSessionIdentifier(sessionIdentifierContainer);
    org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequestOneChannelModel oneChannelModelContainer = new org.bioconductor.packages.caLinearModel.stubs.InvokeFitRequestOneChannelModel();
    oneChannelModelContainer.setOneChannelModel(oneChannelModel);
    params.setOneChannelModel(oneChannelModelContainer);
    org.bioconductor.packages.caLinearModel.stubs.InvokeFitResponse boxedResult = portType.invokeFit(params);
    }
  }
  ...
  public void invokeTwoChannelFit(org.bioconductor.cagrid.statefulservices.SessionIdentifier sessionIdentifier,org.bioconductor.cagrid.calinearmodel.TwoChannelModel twoChannelModel) throws RemoteException {
    synchronized(portTypeMutex){
      configureStubSecurity((Stub)portType,"invokeTwoChannelFit");
    org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequest params = new org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequest();
    org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequestSessionIdentifier sessionIdentifierContainer = new org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequestSessionIdentifier();
    sessionIdentifierContainer.setSessionIdentifier(sessionIdentifier);
    params.setSessionIdentifier(sessionIdentifierContainer);
    org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequestTwoChannelModel twoChannelModelContainer = new org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitRequestTwoChannelModel();
    twoChannelModelContainer.setTwoChannelModel(twoChannelModel);
    params.setTwoChannelModel(twoChannelModelContainer);
    org.bioconductor.packages.caLinearModel.stubs.InvokeTwoChannelFitResponse boxedResult = portType.invokeTwoChannelFit(params);
    }
  }
  ...
  public org.bioconductor.cagrid.statefulservices.Status getStatus(org.bioconductor.cagrid.statefulservices.SessionIdentifier sessionIdentifier) throws RemoteException {
    ...
    org.bioconductor.packages.caLinearModel.stubs.GetStatusRequest params = new org.bioconductor.packages.caLinearModel.stubs.GetStatusRequest();
    org.bioconductor.packages.caLinearModel.stubs.GetStatusRequestSessionIdentifier sessionIdentifierContainer = new org.bioconductor.packages.caLinearModel.stubs.GetStatusRequestSessionIdentifier();
    sessionIdentifierContainer.setSessionIdentifier(sessionIdentifier);
    params.setSessionIdentifier(sessionIdentifierContainer);
    org.bioconductor.packages.caLinearModel.stubs.GetStatusResponse boxedResult = portType.getStatus(params);
