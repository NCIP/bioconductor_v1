 ...
 * 
 */
public class CaMachineLearningContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caMachineLearning.packages.bioconductor.org/CaMachineLearning/Context";
	
	
	public CaMachineLearningContextAuthorization() {
	}
