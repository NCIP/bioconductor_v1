 ...
 * 
 */
public abstract class CaMachineLearningContextResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CaMachineLearningContextResourceBase.class);

	private CaMachineLearningContextResourceConfiguration configuration;
    ...
    public CaMachineLearningContextResourceBase() {
    }
	...
	public CaMachineLearningContextResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaMachineLearningContext";
		...
		try {
			...
			this.configuration = (CaMachineLearningContextResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
