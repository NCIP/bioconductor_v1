package org.bioconductor.packages.caMachineLearning.service.globus.resource;
...
import org.bioconductor.packages.caMachineLearning.common.CaMachineLearningConstants;
import org.bioconductor.packages.caMachineLearning.stubs.CaMachineLearningResourceProperties;
import org.bioconductor.packages.caMachineLearning.service.CaMachineLearningConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class CaMachineLearningResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaMachineLearningResourceBase.class);

	private CaMachineLearningResourceConfiguration configuration;
    ...
    public CaMachineLearningResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaMachineLearningResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaMachineLearningConstants.SERVICEMETADATA);
	...
	public CaMachineLearningResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CaMachineLearningResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CaMachineLearningResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
