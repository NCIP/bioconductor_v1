 ...
 * 
 */
public class CaGeneFilterServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caGeneFilter.packages.bioconductor.org/CaGeneFilterService";
	
	
	public CaGeneFilterServiceAuthorization() {
	}
	...
	public static void authorizeRecode() throws RemoteException {
		
		
	}
					
	public static void authorizeFilter() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("recode")){
			try{
				authorizeRecode();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("filter")){
			try{
				authorizeFilter();
				return true;
			} catch (Exception e){
