 ...
 * 
 */
public abstract class CaGeneFilterServiceContextResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CaGeneFilterServiceContextResourceBase.class);

	private CaGeneFilterServiceContextResourceConfiguration configuration;
    ...
    public CaGeneFilterServiceContextResourceBase() {
    }
	...
	public CaGeneFilterServiceContextResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaGeneFilterServiceContext";
		...
		try {
			...
			this.configuration = (CaGeneFilterServiceContextResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
