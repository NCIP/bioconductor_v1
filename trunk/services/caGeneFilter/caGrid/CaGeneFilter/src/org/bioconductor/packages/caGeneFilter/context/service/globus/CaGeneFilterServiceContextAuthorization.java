 ...
 * 
 */
public class CaGeneFilterServiceContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caGeneFilter.packages.bioconductor.org/CaGeneFilterService/Context";
	
	
	public CaGeneFilterServiceContextAuthorization() {
	}
