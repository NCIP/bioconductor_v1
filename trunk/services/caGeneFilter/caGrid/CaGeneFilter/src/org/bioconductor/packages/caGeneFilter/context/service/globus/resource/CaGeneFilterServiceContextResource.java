 ...
 * 
 */
public class CaGeneFilterServiceContextResource extends CaGeneFilterServiceContextResourceBase {
...
//						  m_clientFilesStoredLocUrlList.add(transSrvCxtClient.getDataTransferDescriptor().getUrl());
			                                                                           ...
			                                                                           final org.bioconductor.rserviceJms.services.caGeneFilter.caGeneFilter caGeneFilter) throws Exception
	{
		try {
			...
			// create caGeneFilter instance to make a call			 
			...
			// this returned object array should have length of 2, one for each channel: red & green.
