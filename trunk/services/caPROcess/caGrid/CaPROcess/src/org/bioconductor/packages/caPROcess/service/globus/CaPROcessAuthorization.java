 ...
 * 
 */
public class CaPROcessAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caPROcess.packages.bioconductor.org/CaPROcess";
	
	
	public CaPROcessAuthorization() {
	}
	...
	public static void authorizeGetPeakLocation() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getPeakLocation")){
			try{
				authorizeGetPeakLocation();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
