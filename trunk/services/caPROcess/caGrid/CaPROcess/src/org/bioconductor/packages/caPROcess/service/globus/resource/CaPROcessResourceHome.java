 ...
 * 
 */
public class CaPROcessResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CaPROcessResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    CaPROcessResourceProperties props = new CaPROcessResourceProperties();
			CaPROcessResource resource = new CaPROcessResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, CaPROcessConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, CaPROcessConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CaPROcessResource resource = (CaPROcessResource) super.find(key);
		return resource;
	}
     ...
     */
    public CaPROcessResource getAddressedResource() throws Exception {
        CaPROcessResource thisResource;
        thisResource = (CaPROcessResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}