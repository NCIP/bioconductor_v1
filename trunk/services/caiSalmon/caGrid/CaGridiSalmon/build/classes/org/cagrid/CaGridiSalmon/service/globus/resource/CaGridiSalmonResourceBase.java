package org.cagrid.CaGridiSalmon.service.globus.resource;
...
import org.cagrid.CaGridiSalmon.common.CaGridiSalmonConstants;
import org.cagrid.CaGridiSalmon.stubs.CaGridiSalmonResourceProperties;
import org.cagrid.CaGridiSalmon.service.CaGridiSalmonConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class CaGridiSalmonResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaGridiSalmonResourceBase.class);

	private CaGridiSalmonResourceConfiguration configuration;
    ...
    public CaGridiSalmonResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaGridiSalmonResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaGridiSalmonConstants.SERVICEMETADATA);
	...
	public CaGridiSalmonResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CaGridiSalmonResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CaGridiSalmonResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
