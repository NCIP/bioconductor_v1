 ...
 * 
 */
public class CaArrayQualityMetricsAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caArrayQualityMetrics.packages.bioconductor.org/CaArrayQualityMetrics";
	
	
	public CaArrayQualityMetricsAuthorization() {
	}
