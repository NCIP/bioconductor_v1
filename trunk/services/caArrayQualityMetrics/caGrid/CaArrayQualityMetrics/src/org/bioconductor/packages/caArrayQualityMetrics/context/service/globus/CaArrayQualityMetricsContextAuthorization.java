 ...
 * 
 */
public class CaArrayQualityMetricsContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caArrayQualityMetrics.packages.bioconductor.org/CaArrayQualityMetrics/Context";
	
	
	public CaArrayQualityMetricsContextAuthorization() {
	}
