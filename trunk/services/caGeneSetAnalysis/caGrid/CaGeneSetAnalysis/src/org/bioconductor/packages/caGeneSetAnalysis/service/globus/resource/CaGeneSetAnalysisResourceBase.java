...
import org.bioconductor.packages.caGeneSetAnalysis.common.CaGeneSetAnalysisConstants;
import org.bioconductor.packages.caGeneSetAnalysis.stubs.CaGeneSetAnalysisResourceProperties;
 ...
 * 
 */
public abstract class CaGeneSetAnalysisResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaGeneSetAnalysisResourceBase.class);

	private CaGeneSetAnalysisResourceConfiguration configuration;
    ...
    public CaGeneSetAnalysisResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaGeneSetAnalysisResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaGeneSetAnalysisConstants.SERVICEMETADATA);
	...
	public CaGeneSetAnalysisResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CaGeneSetAnalysisResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CaGeneSetAnalysisResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
