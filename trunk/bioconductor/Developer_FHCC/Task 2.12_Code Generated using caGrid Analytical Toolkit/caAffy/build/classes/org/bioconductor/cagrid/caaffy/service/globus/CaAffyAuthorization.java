 ...
 * 
 */
public class CaAffyAuthorization{
	
	
	public CaAffyAuthorization() {
	}
	...
	public static void authorizeCaExpresso() throws RemoteException {
		
		
	}
					
	public static void authorizeCaQAReport() throws RemoteException {
