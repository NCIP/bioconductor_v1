 ...
 * of its use. */
    ...
    private gov.nih.nci.mageom.domain.quantitationtype.QuantitationType[] quantitationTypes;
    ...
    public QuantitationTypeDimension(
           ...
           gov.nih.nci.mageom.domain.quantitationtype.QuantitationType[] quantitationTypes) {
           this.name = name;
 ...
 * of its use.
     ...
     */
    public gov.nih.nci.mageom.domain.quantitationtype.QuantitationType[] getQuantitationTypes() {
        return quantitationTypes;
    }
     ...
     */
    public void setQuantitationTypes(gov.nih.nci.mageom.domain.quantitationtype.QuantitationType[] quantitationTypes) {
        this.quantitationTypes = quantitationTypes;
    }

    public gov.nih.nci.mageom.domain.quantitationtype.QuantitationType getQuantitationTypes(int i) {
        return this.quantitationTypes[i];
    }

    public void setQuantitationTypes(int i, gov.nih.nci.mageom.domain.quantitationtype.QuantitationType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caArray.caBIG/1.1/gov.nih.nci.mageom.domain.BioAssayData", "QuantitationTypeDimension"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "quantitationTypes"));
