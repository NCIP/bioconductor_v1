 ...
 */
public abstract class Identifiable  extends gov.nih.nci.mageom.domain.Describable  implements java.io.Serializable {
 ...
 * of its use.
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caArray.caBIG/1.1/gov.nih.nci.mageom.domain", "Identifiable"));
