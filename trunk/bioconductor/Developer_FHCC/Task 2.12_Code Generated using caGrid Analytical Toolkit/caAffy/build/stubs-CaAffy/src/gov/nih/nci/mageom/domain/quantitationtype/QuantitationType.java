 ...
 */
public abstract class QuantitationType  extends gov.nih.nci.mageom.domain.Identifiable  implements java.io.Serializable {
 ...
 * or from the feature itself.
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caArray.caBIG/1.1/gov.nih.nci.mageom.domain.QuantitationType", "QuantitationType"));
