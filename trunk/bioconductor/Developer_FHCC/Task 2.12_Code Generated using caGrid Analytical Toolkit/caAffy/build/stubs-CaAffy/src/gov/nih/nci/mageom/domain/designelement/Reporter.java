 ...
 */
public class Reporter  extends gov.nih.nci.mageom.domain.designelement.DesignElement  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caArray.caBIG/1.1/gov.nih.nci.mageom.domain.DesignElement", "Reporter"));
    }
