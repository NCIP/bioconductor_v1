...
public class DerivedBioAssay  extends gov.nih.nci.mageom.domain.bioassay.BioAssay  implements java.io.Serializable {
    private DerivedBioAssayData[] derivedBioAssayData;
     ...
     */
    public void setDerivedBioAssayData(DerivedBioAssayData[] derivedBioAssayData) {
        this.derivedBioAssayData = derivedBioAssayData;
    }

    public DerivedBioAssayData getDerivedBioAssayData(int i) {
        return this.derivedBioAssayData[i];
    }

    public void setDerivedBioAssayData(int i, DerivedBioAssayData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bioassay.domain.mageom.nci.nih.gov", "DerivedBioAssay"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("derivedBioAssayData");
        elemField.setXmlName(new javax.xml.namespace.QName("http://bioassay.domain.mageom.nci.nih.gov", "derivedBioAssayData"));
