 ...
 */
public class BioDataCube  extends gov.nih.nci.mageom.domain.bioassaydata.BioDataValues  implements java.io.Serializable {
 ...
 * letter of the three dimensions to represent the six possible orderings.
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caArray.caBIG/1.1/gov.nih.nci.mageom.domain.BioAssayData", "BioDataCube"));
