 ...
 * 
 */
public class CaDNAcopyAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caDNAcopy.packages.bioconductor.org/CaDNAcopy";
	
	
	public CaDNAcopyAuthorization() {
	}
	...
	public static void authorizeGetDerivedDNAcopySegment() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getDerivedDNAcopySegment")){
			try{
				authorizeGetDerivedDNAcopySegment();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
