...
public class CaDNAcopyImpl extends CaDNAcopyImplBase {
	...
	System.out.println("Start caDNAcopy successful");
       ...
       /**
        * Java interface to R function caDNAcopy.
	...
	*	identifying chromosomal regions of constant copy
        *       number.
        *
        * @param dnacopyAssays	Collection of objects representing 
	*	samples from known chromosomal locations, and their 
	*	expression values.
        * @param dnacopyParameter       An object encapsulating
        *       parameters influencing evaluation of caDNAcopy.
        * @return	Java representation of the 
	*	DerivedDNAcopySegment-class in R.
        */
