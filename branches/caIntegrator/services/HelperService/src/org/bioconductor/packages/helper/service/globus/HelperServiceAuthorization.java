 ...
 * 
 */
public class HelperServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://helper.packages.bioconductor.org/HelperService";
	
	
	public HelperServiceAuthorization() {
	}
	...
	public static void authorizeTestContextLookup() throws RemoteException {
		
		
	}
					
	public static void authorizeGetUploadFileReferences() throws RemoteException {
		
		
	}
					
	public static void authorizeGetUploadObjectReference() throws RemoteException {
		
		
	}
					
	public static void authorizeGetDownloadObjectReference() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("testContextLookup")){
			try{
				authorizeTestContextLookup();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getUploadFileReferences")){
			try{
				authorizeGetUploadFileReferences();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getUploadObjectReference")){
			try{
				authorizeGetUploadObjectReference();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
