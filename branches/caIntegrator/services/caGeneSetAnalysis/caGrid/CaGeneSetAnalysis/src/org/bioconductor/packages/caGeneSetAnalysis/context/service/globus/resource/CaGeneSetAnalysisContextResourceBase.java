 ...
 * 
 */
public abstract class CaGeneSetAnalysisContextResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CaGeneSetAnalysisContextResourceBase.class);

	private CaGeneSetAnalysisContextResourceConfiguration configuration;
    ...
    public CaGeneSetAnalysisContextResourceBase() {
    }
	...
	public CaGeneSetAnalysisContextResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaGeneSetAnalysisContext";
		...
		try {
			...
			this.configuration = (CaGeneSetAnalysisContextResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
