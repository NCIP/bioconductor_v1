 ...
 * 
 */
public class CaGeneSetAnalysisContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caGeneSetAnalysis.packages.bioconductor.org/CaGeneSetAnalysis/Context";
	
	
	public CaGeneSetAnalysisContextAuthorization() {
	}
