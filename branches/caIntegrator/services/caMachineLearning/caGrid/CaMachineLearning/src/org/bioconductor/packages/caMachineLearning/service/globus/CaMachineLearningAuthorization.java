 ...
 * 
 */
public class CaMachineLearningAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caMachineLearning.packages.bioconductor.org/CaMachineLearning";
	
	
	public CaMachineLearningAuthorization() {
	}
	...
	public static void authorizeLearn() throws RemoteException {
		
		
	}
					
	public static void authorizeCreateCaMachineLearningSession() throws RemoteException {
		
		
	}
					
	public static void authorizeInvokeLearn() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("learn")){
			try{
				authorizeLearn();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("createCaMachineLearningSession")){
			try{
				authorizeCreateCaMachineLearningSession();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("invokeLearn")){
			try{
				authorizeInvokeLearn();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
