...
import org.bioconductor.packages.caMachineLearning.context.common.CaMachineLearningContextConstants;
import org.bioconductor.packages.caMachineLearning.context.stubs.CaMachineLearningContextResourceProperties;
 ...
 * 
 */
public class CaMachineLearningContextResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		CaMachineLearningContextResource resource = (CaMachineLearningContextResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		CaMachineLearningContextResourceProperties props = new CaMachineLearningContextResourceProperties();
        ...
        resource.initialize(props, CaMachineLearningContextConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.bioconductor.packages.caMachineLearning.context.stubs.types.CaMachineLearningContextReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public CaMachineLearningContextResource getResource(ResourceKey key) throws ResourceException {
		CaMachineLearningContextResource thisResource = (CaMachineLearningContextResource)find(key);
		return thisResource;
	}
     ...
     */
    public CaMachineLearningContextResource getAddressedResource() throws Exception {
        CaMachineLearningContextResource thisResource;
        thisResource = (CaMachineLearningContextResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
