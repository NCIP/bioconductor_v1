package org.bioconductor.packages.caArrayQualityMetrics.service.globus.resource;
...
import org.bioconductor.packages.caArrayQualityMetrics.common.CaArrayQualityMetricsConstants;
import org.bioconductor.packages.caArrayQualityMetrics.stubs.CaArrayQualityMetricsResourceProperties;
 ...
 * 
 */
public abstract class CaArrayQualityMetricsResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CaArrayQualityMetricsResourceBase.class);

	private CaArrayQualityMetricsResourceConfiguration configuration;
    ...
    public CaArrayQualityMetricsResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CaArrayQualityMetricsResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CaArrayQualityMetricsConstants.SERVICEMETADATA);
	...
	public CaArrayQualityMetricsResourceConfiguration getConfiguration() {
		...
		servicePath+="/CaArrayQualityMetrics";
		...
		try {
			...
			this.configuration = (CaArrayQualityMetricsResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CaArrayQualityMetricsResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
