 ...
 * 
 */
public class CaGridiSalmonAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://CaGridiSalmon.cagrid.org/CaGridiSalmon";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CaGridiSalmonAuthorization() {
	}
	...
	public void authorizeCamiRNATwoGroupDifferentialExpression(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("camiRNATwoGroupDifferentialExpression")){
			authorizeCamiRNATwoGroupDifferentialExpression(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
