/**
 * CaGridiSalmonResourceProperties.java
 *
...
public class CaGridiSalmonResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public CaGridiSalmonResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this CaGridiSalmonResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this CaGridiSalmonResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CaGridiSalmonResourceProperties)) return false;
        CaGridiSalmonResourceProperties other = (CaGridiSalmonResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CaGridiSalmonResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://CaGridiSalmon.cagrid.org/CaGridiSalmon", ">CaGridiSalmonResourceProperties"));
