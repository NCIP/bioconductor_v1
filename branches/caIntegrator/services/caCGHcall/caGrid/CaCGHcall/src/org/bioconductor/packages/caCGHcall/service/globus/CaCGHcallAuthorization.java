 ...
 * 
 */
public class CaCGHcallAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caCGHcall.packages.bioconductor.org/CaCGHcall";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CaCGHcallAuthorization() {
	}
	...
	public void authorizeGetDerivedCGHcallSegment(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getDerivedCGHcallSegment")){
			authorizeGetDerivedCGHcallSegment(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
